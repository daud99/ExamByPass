...
<nav class="navbar" :class="[
    ...
    <div class="container-fluid">
        ...
        <navbar-toggle-button class="burger" :toggled="toggled" :target="contentId" @click.native.stop="toggled = !toggled">
...
export default {
    ...
    created() {
        console.log("in bas enav", this.background, this.effect)
    },
    data() {
        return {
            toggled: false
