...
export default {
    ...
    computed: {
        getSourceElements() {
            ...
            const result = this.answer_area.filter(el => el.place_type === 'SOURCE');
            console.log(this.answer_area, result);
            return result
        },
        getAllElements() {
            // console.log(
            //   this.question.answers.members.placesInfo.elements,
            //   this.answer_area
            // );
            //return this.question.answers.members.placesInfo.elements;
            console.log(this.answer_area);
        ...
        getTargetElements() {
            ...
            // );
            console.log(this.answer_area);
            return this.answer_area.filter((el) => el.place_type === "TARGET");
        },
    },
    methods: {
        getAnswers() {
            ...
            axios
                ...
                .then((resp) => {
                    ...
                    if (
                        ...
                        this.question.type === "SELECT_AND_PLACE"
                    ) {
                        this.getAnswerArea();
                    }
        ...
        submit() {
            ...
            console.log("source answer", sourceTypeAnswers)
            let correctAnswers = [];
            ...
            for (let el of sourceTypeAnswers) {
                ...
                console.log("i am in for of source answer display answerobject", answerObject)
                if (!answerObject || answerObject.correct_object_index + 1 != el.id) {
                    this.wrongAnswered = true;
                    break;
                }
            }
            console.log(this.wrongAnswered)
        ...
        showAnswerImage(answers) {
            ...
            image.src = this.questionn.task_image;
            // console.log("i am first show ans", answers, this.getSourceElements.find(
            //     (elm) => elm
            ...
            image.onload = () => {
                ...
                answers.forEach((el) => {
                    ...
                    let elm2 = this.getSourceElements.find(

                    )
                    console.log(" i am show answer", el, elm2.id)

                    let sourceAnswer = this.getSourceElements.find(
                        (elm) => elm.id === el.correct_object_index + 1
