    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col offset-lg-2 offset-md-2 col-lg-7 col-md-7 col-xs-12">
            ...
            <v-text-field
                :error-messages="problemTypeErrors"
                v-model="problemType"
                :counter="20"
                label="Problem Type"
                outlined
                shaped
                @input="$v.problemType.$touch()"
                @blur="$v.problemType.$touch()"
                required
            ></v-text-field>
...
export default {
  ...
  validations: {
    ...
    problemType: { required, maxLength: maxLength(20),minLength: minLength(1) },
    message: { required, maxLength: maxLength(20),minLength: minLength(1) },
